...
class FormResetPasswordCompany extends Component {
    constructor(props) {
        super(props)
    ...
    handleSubmitForm = (e) => {
        ...
        axios.post(host + `/api/company/reset/handle/password`, data)
        .then(res => {
...
export default connect(mapStateToProps, mapDispatchToProps )(FormResetPasswordCompany)
