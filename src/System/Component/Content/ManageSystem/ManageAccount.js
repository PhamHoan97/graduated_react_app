        ...
        return (
            <div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                    <div className="col-md-12">
                        <h3 className="title-5 m-b-35 manage__company--notification">Manager Company</h3>
                        <div className="table-data__tool">
                        <div className="table-data__tool-left">
                            <div className="rs-select2--light rs-select2--sm">
                            <select className="js-select2 select--today__adminAccount" name="time">
                        ...
                        <table className="table table-data2">
                            ...
                            <tr className="tr-shadow">
                                ...
                                <td>
                                <img src="./system/images/icon/avatar-01.jpg" alt="aaa" />
                                </td>
                                <td className="desc">Active</td>
                                <td>
                                <div className="table-data-feature">
                                    <button className="item" data-toggle="tooltip" data-placement="top" title="Approve">
                                    <i className="zmdi zmdi-notifications-add" />
                                    </button>
                                    <button className="item" data-toggle="tooltip" data-placement="top" title="Reject">
                                    <i className="zmdi zmdi-xbox" />
                                    </button>
                                    <button className="item" data-toggle="modal" data-target="#scrollmodal" data-placement="top" title="New Account Admin">
                ...
                <div className="modal-dialog modal-lg" role="document">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="scrollmodalLabel">New Account Admin</h5>
                    ...
                    <div className="modal-body">
                        ...
                        <form action method="post" encType="multipart/form-data" className="form-horizontal">
                            ...
                            <div className="col col-md-3">
                                <label htmlFor="text-input" className=" form-control-label">Username</label>
                            </div>
                            ...
                            <div className="col-12 col-md-9">
                                <input type="email" id="text-input" name="text-input" placeholder="Text" className="form-control" />
                                <small className="form-text text-muted">This is a help text</small>
                            </div>
                            </div>
                        </form>
