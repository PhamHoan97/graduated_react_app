                ...
                <div className="section__content section__content--p30">
                    <div className="container-fluid">
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="container">
                                <div className="row">
                                <div className="col-md-12">
                                    <h3 className="title-5 m-b-35 manage__process--title">Manager Process in company</h3>
                                    <div className="table-data__tool">
                                    <div className="table-data__tool-left">
                                        <div className="rs-select2--light rs-select2--md">
                                        <select className="js-select2 select--department__process" name="property" defaultValue={'DEFAULT'}>
                                        ...
                                        <select className="js-select2 select--today__process" name="time">
                                    ...
                                    <div className="table-data__tool-right">
                                        <button className="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#scrollmodal">
                                    ...
                                    <table className="table table-data2">
                                        ...
                                        <tr className="tr-shadow">
                                            ...
                                            <td>
                                            <span className="block-email">Sale</span>
                                            </td>
                                            <td className="desc">Samsung S8 Black</td>
                                            <td>2018-09-27 02:12</td>
                                            <td>
                                            <span className="status--process">Success</span>
                                            </td>
                                            <td>
                                            <div className="table-data-feature">
                                                <button className="item" data-toggle="tooltip" data-placement="top" title="Evaluate Form">
                                                <i className="zmdi zmdi-file" />
                                                </button>
                                                <button className="item" data-toggle="tooltip" data-placement="top" title="Download">
                    ...
                    <div className="modal-dialog modal-lg" role="document">
                        ...
                        <div className="modal-header">
                            <h5 className="modal-title" id="scrollmodalLabel">New process</h5>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="card-body card-block">
                                ...
                                <div className="row form-group">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="" className="form-control" />
                                    <small className="form-text text-muted">This is a help text</small>
                                    </div>
                                </div>
                                <div className="row form-group">
                                    <div className="col col-md-3">
                                    <label htmlFor="disabled-input" className=" form-control-label">Company</label>
                                    </div>
                                    <div className="col-12 col-md-9">
                                    <input type="text" id="company" name="company" placeholder="Disabled" disabled className="form-control" />
                                    </div>
                                </div>
                                <div className="row form-group">
                                    <div className="col col-md-3">
                                    ...
                                    <div className="col-12 col-md-9">
                                    <textarea name="description" id="description" rows={9} placeholder="Content..." className="form-control" defaultValue={""} />
                                    </div>
                                </div>
                                <div className="row form-group">
                                    <div className="col col-md-3">
